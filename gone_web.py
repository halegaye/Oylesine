...
WEB_APP_URL = "https://manly-broaden-skedaddle.ngrok-free.dev"
...
async def start_command(update, context):
    ...
    # ❌ ESKİ: await update.message.reply_text("Merhaba! Botumuza hoş geldiniz.")
    # ✅ YENİ: kanal üyeliğine göre yönlendirme
